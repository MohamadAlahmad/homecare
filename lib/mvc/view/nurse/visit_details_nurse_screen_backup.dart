...
class VisitDetailsNurseScreen extends StatefulWidget {
  ...
  final String lab;
  const VisitDetailsNurseScreen({super.key, required this.serviceName, required this.patientName, required this.location, required this.sessionId, required this.patientId, required this.servicePrice, required this.forLabService, required this.labTests, required this.lab});
          ...
          child: Column(
            children: [
              ...
              AnimatedToggleSwitch<int>.size(
                ...
                current: value,
                values: widget.forLabService ? const [0] : const [0, 1], // For two pages
                iconOpacity: 1.0,
          ...
          child: Column(
            ...
            children: [
              ...
              for(int i = 0; i < widget.labTests.length; i++)
                CustomItemCard(
                  id: widget.labTests[i].id,
                  title: widget.labTests[i].name,
                  value: widget.labTests[i].price,
                  isSelected: true,
                  forLabTest: true,
                ),
              Padding(

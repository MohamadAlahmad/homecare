...
Container CustomItemCard({required int id, required String title, required num value, required bool isSelected, bool forLabTest = false}) {
  return Container(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            forLabTest? Text('ل.س', style: TextStyle(fontSize: 12.0, color: isSelected ? Colors.white : Colors.black)) : Expanded(child: Icon(Icons.star, color: Colors.amberAccent, size: isSelected ? 15.0 : 13.0)),
          ],
        ),
      ],
    ),

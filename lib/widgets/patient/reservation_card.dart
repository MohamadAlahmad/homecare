              ...
              children: [
                ...
                Row(
                  children: [
                    CircleAvatar(
                      radius: 12.0,
                      backgroundImage: AssetImage('assets/images/nurse_temp.png'),
                    ),
                    const SizedBox(width: 5.0),
                    Text(nurseName.isNotEmpty ? nurseName : '(لم يتم تحديد الممرض)', style: TextStyle(fontSize: nurseName.isEmpty ? 10.0 :12.0)),
                  ],
                ),
              ],
            ),
            ...
            children: [
              SizedBox(
                ...
                child: IconButton(
                  ...
                  icon: Text('إلغاء الطلب',
                      style: TextStyle(
                          color: HomeCareTheme.primaryColorBold, fontSize: 14.0)),
                ),
              ),
              SizedBox(
                width: 140.0,

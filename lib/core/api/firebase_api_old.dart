    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (message.notification?.title != null) {
        Get.snackbar(
          ...
          isDismissible: true,
          icon: Image.asset('assets/appIcon/icon.png'),
          ...
          titleText: Directionality(
            ...
            child: Text(
              ...
              style: const TextStyle(color: HomeCareTheme.primaryColor, fontSize: 14.0),
            ),
          ),
        ...
        Get.snackbar(
          ...
          titleText: Directionality(  // 👈 Forces RTL Layout
            ...
            child: const Text(
              'لا يوجد عنوان',
              style: TextStyle(color: HomeCareTheme.primaryColor, fontSize: 14.0),
            ),
          ),
          messageText: Directionality(
            textDirection: TextDirection.rtl,
